...
public enum ServerWorld {
    CREATIVE("creative", ChatColor.YELLOW, "" + ChatColor.YELLOW + ChatColor.BOLD + "Creative " + ChatColor.GRAY + "> " + ChatColor.RESET),
    SURVIVAL("world", ChatColor.GREEN, "" + ChatColor.GREEN + ChatColor.BOLD + "Survival " +ChatColor.GREEN + " > " + ChatColor.RESET);

    private String worldName;
    private ChatColor color;
    private String announcementFormat;

    ServerWorld(String worldName, ChatColor color, String announcementFormat) {
